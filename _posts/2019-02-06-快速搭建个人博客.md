...
> 正所谓前人栽树，后人乘凉。
> 
> 该原教程来自 [QiuBai Ying 的 Github](https://github.com/qiubaiying/qiubaiying.github.io/wiki)，同时感谢[Huxpro](https://github.com/huxpro)提供的博客模板，自己做了修改。
> 
> [我的的博客](http://gjxaiou.com)



# 一、快速开始

搭建博客的方式是使用 [GitHub Pages](https://pages.github.com/) + [jekyll](http://jekyll.com.cn/) 的方式。

### （一）拉取博客模板

直接打开我的 [GitHub 仓库](https://github.com/GJXAIOU/gjxaiou.github.io)，点击右上角的 **Fork** 将我的仓库拉倒你的账号下
...
- 点击自己仓库片右上角的**settings**进入设置

- 修改仓库名为 `你的Github账号名.github.io`，然后 Rename

- 这时你在在浏览器中输入 `你的Github账号名.github.io` 例如: `gjxaiou.github.io`你将会看到博客主页面。
